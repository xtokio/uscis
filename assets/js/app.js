class App
{
    static questions()
    {
        let array = [
            ...
            {num: 20, question: 'Who is one of your state’s U.S. Senators now?*', answers:[{num: 1, answer: 'Todd Young (R)'},{num: 2, answer: 'Mike Braun (R)'}]},
            ...
            {num: 43, question: 'Who is the Governor of your state now?', answers:[{num: 1, answer: 'Eric Holcomb'}]},
            ...
            {num: 47, question: 'What is the name of the Speaker of the House of Representatives now?', answers:[{num: 1, answer: 'Nancy Pelosi'},{num: 2, answer: 'Pelosi'}]},
